...
import com.example.test.letspray.api.ApiService;
import com.example.test.letspray.api.ApiUrl;
...
public class MainActivityjs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainjs);
    ...
    private void getJadwal () {
        ...
        progressDialog = new ProgressDialog(MainActivityjs.this);
        ...
        call.enqueue(new Callback<ModelJadwal>() {
            ...
            public void onFailure(Call<ModelJadwal> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MainActivityjs.this, "Sorry, please try again... server Down..", Toast.LENGTH_SHORT).show();
            }
        });
